 ...
 *  
 *  Personal Comments:
 *  I created this Unrar64 wrapper class for personal use 
 *  after running into a number of issues trying to use
 *  another COM Unrar64 product via COM interop.  I hope it 
...
namespace Schematrix
{
    ...
    /// <summary>
    /// Wrapper class for Unrar64 DLL supplied by RARSoft.  
    /// Calls Unrar64 DLL via platform invocation services (pinvoke).
    /// DLL is available at http://www.rarlab.com/rar/Unrar64DLL.exe
    /// </summary>
    public class Unrar64 : IDisposable
    {
        #region Unrar64 DLL enumerations
        ...
        #region Unrar64 DLL structure definitions
        ...
        #region Unrar64 function declarations
        ...
        [DllImport("Unrar64.dll")]
        private static extern void RARSetCallback(IntPtr hArcData, Unrar64Callback callback, int userData);

        [DllImport("Unrar64.dll")]
        private static extern void RARSetPassword(IntPtr hArcData,
            [MarshalAs(UnmanagedType.LPStr)] string password);

        // Unrar64 callback delegate signature
        private delegate int Unrar64Callback(uint msg, int UserData, IntPtr p1, int p2);
        ...
        private Unrar64Callback callback = null;
        ...
        public Unrar64()
        {
            this.callback = new Unrar64Callback(RARCallback);
        }
        ...
        public void Skip()
        {
            int result = Unrar64.RARProcessFile(this.archiveHandle, (int)Operation.Skip, string.Empty, string.Empty);
        ...
        public void Test()
        {
            int result = Unrar64.RARProcessFile(this.archiveHandle, (int)Operation.Test, string.Empty, string.Empty);
        ...
        {
            int result = Unrar64.RARProcessFile(this.archiveHandle, (int)Operation.Extract, destinationPath, destinationName);
